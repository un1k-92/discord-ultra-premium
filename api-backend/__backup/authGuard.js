...
module.exports = function authGuard(opts = {}) {
  ...
  return (req, res, next) => {
    ...
    const token = (hdr.startsWith("Bearer ") ? hdr.slice(7) : null) || (req.cookies ? req.cookies.token : null);
...
'@ | Set-Content -Encoding UTF8 C:\discord-ultra-PSAAS\api-backend\src\middlewares\authGuard.js
